...
7. **`[ADDED 2026-07-29]` Given** a generated Scenario recreates an exploration path that passed through a step which used discovery-time test data (a user-supplied unblocking value, Story 2.16, or a Data-Resolver-synthesized value, Story 2.13, including a placeholder upload file), **then** that same value is surfaced as the default Test Data value for that step (AC 3/6's Test data form), not regenerated or left blank. [Source: `sprint-change-proposal-2026-07-29.md`; FR-47]
